...
If you're an engineer thinking about PM, here's my honest advice: don't rush it. First, start doing PM-adjacent work in your current role — volunteer for sprint planning, write a mini-PRD for a feature you care about, present a customer problem to your team. Second, find a PM mentor who can give you unfiltered feedback on your product thinking. Third, consider an internal transfer before an external one — you already have context and credibility at your current company. And finally, know that you'll feel like a beginner again. That discomfort is the growth. Lean into it.`,
  },
  {
    id: "5",
