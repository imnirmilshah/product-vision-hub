...
const COMPONENTS: ComponentInfo[] = [
  {
    ...
    technical: "Raw string input tokenized via BPE into integer token IDs from a fixed vocabulary (typically 32K–100K tokens).",
  },
  {
    id: "token-embed",
  ...
  },
  {
    ...
    height: 34,
    color: "hsl(var(--green))",
    simple: "A cleanup step — adds the original input back in and normalizes, keeping training stable.",
